...
export default function HeartContent() {
    ...
    return (
        <>
            <section>
                <p className="max-w-6xl text-center mx-auto text-3xl lg:text-4xl xl:text-[44px] leading-tight text-black my-8 mb-0 lg:my-10 xl:my-12">A heart-coherence journey grounded in science and designed to support stress regulation, anxiety relief and emotional balance.</p>
            </section>
                    ...
                    <div className="grid grid-cols-1 items-start gap-8 lg:gap-10 lg:grid-cols-5">
                        ...
                        <div className="flex justify-center lg:justify-end col-span-2 order-1 lg:order-2">
                            <div className="mx-auto mt-4 w-65 sm:w-[320px] md:w-95 lg:mt-0 lg:mx-0 lg:w-107.5 xl:w-117.5 2xl:w-127.5">
                                <div
                                    className="h-100 w-65 overflow-hidden rounded-t-[160px] rounded-b-none p-px sm:h-135 sm:w-80 sm:rounded-t-[200px] md:h-155 md:w-90 md:rounded-t-[230px] lg:h-165 lg:w-100 lg:rounded-t-[250px] xl:h-195 xl:w-115 xl:rounded-t-[270px] 2xl:h-200 2xl:w-117.5 2xl:rounded-t-[290px]"
                ...
                <div className="max-w-7xl mx-auto w-full px-6 py-12 md:px-10 lg:px-12 xl:px-14">
                    <div className="grid grid-cols-1 items-start gap-8 lg:gap-10 lg:grid-cols-5">
                        <div className="flex justify-center lg:justify-end col-span-2 order-1 lg:order-1">
                            <div className="mx-auto mt-4 w-65 sm:w-[320px] md:w-95 lg:mt-0 lg:mx-0 lg:w-107.5 xl:w-117.5 2xl:w-127.5">
                                <div
                                    className="h-100 w-65 overflow-hidden rounded-t-[160px] rounded-b-none p-px sm:h-127 sm:w-80 sm:rounded-t-[200px] md:h-147 md:w-90 md:rounded-t-[230px] lg:h-158 lg:w-100 lg:rounded-t-[250px] xl:h-188 xl:w-115 xl:rounded-t-[270px] 2xl:h-190 2xl:w-117.5 2xl:rounded-t-[290px]"
                                    style={{ background: "var(--dark-gold)" }}
                                >
                                    <div className="relative h-full w-full overflow-hidden rounded-t-[inherit] rounded-b-none bg-white p-1">
                                        <div
            ...
            <section className="w-full bg-[#fcf1ea]">
                <div className="max-w-7xl mx-auto w-full px-6 py-16 lg:py-22 xl:py-30 md:px-10 lg:px-12 xl:px-14">
                    <div className="grid grid-cols-1 items-center gap-8 lg:gap-10 lg:grid-cols-12">
                        ...
                        {/* Heading */}
                        <div className="col-span-5 w-full lg:max-w-[85%] order-1 lg:order-2">
                            <h2 className="text-[#3E2925] text-4xl lg:text-5xl xl:text-[54px] font-bold leading-snug lg:leading-17">
                                Heart Codes Helps You Make This Shift — Gently and Practically
                            </h2>
                        </div>

                        {/* Content */}
                        <div className="col-span-7 text-black text-xl lg:text-2xl xl:text-[26px] leading-snug order-2 lg:order-1">
                            ...
                            <p className="mt-4">
                                These practices support you during a difficult moment, a busy day, or anytime you need to return to yourself.
                            </p>
                        </div>
            ...
            <section>
                <div className="mt-16 bg-[#fcf1ea] px-4 py-10 lg:py-14 xl:py-12 md:px-8 lg:px-10 xl:px-12  w-full">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center">
                            <h2 className="text-black text-6xl lg:text-5xl xl:text-[54px] leading-tight lg:leading-snug tracking-tighter font-semibold">
                ...
                <div className="max-w-7xl mx-auto w-full px-6 py-12 md:px-10 lg:px-12 xl:px-14">
                    <div className="grid grid-cols-1 items-start gap-8 lg:gap-10 lg:grid-cols-5">
                        ...
                        <div className="flex justify-center lg:justify-end col-span-2 order-1 lg:order-2">
                            <div className="mx-auto mt-4 w-65 sm:w-[320px] md:w-95 lg:mt-0 lg:mx-0 lg:w-107.5 xl:w-117.5 2xl:w-127.5">
                                <div
                                    className="h-100 w-65 overflow-hidden rounded-t-[160px] rounded-b-none p-px sm:h-105 sm:w-80 sm:rounded-t-[200px] md:h-120 md:w-90 md:rounded-t-[230px] lg:h-130 lg:w-100 lg:rounded-t-[250px] xl:h-145 xl:w-115 xl:rounded-t-[270px] 2xl:h-150.5 2xl:w-117.5 2xl:rounded-t-[290px]"
                                    style={{ background: "var(--dark-gold)" }}
                                >
                                    <div className="relative h-full w-full overflow-hidden rounded-t-[inherit] rounded-b-none bg-white p-1">
                                        <div
            ...
            <section className="w-full bg-[#fcf1ea]">
                <div className="max-w-7xl mx-auto w-full px-6 py-14 md:px-10 lg:px-12 xl:px-14 lg:py-18 xl:py-22">
                    <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
                        <div className="text-black flex flex-col justify-center h-full translate-y-[-8%] pl-1 lg:pl-10 xl:pl-12">
                            <h2 className="text-[#3E2925] text-4xl lg:text-5xl xl:text-[54px] font-bold leading-15 tracking-tight flex flex-row lg:flex-col whitespace-nowrap lg:whitespace-normal">
                                <span>Who Is Heart</span>
                                <span className="ml-2 lg:ml-0">Codes For?</span>
                            </h2>
                    ...
                    <div className="grid grid-cols-1 items-start gap-8 lg:gap-10 lg:grid-cols-5">
                        <div className="col-span-3 pr-4 order-2 lg:order-1">
                            <div className="flex flex-col gap-6 pt-1">
                                ...
                                <div
                                    className="relative hidden lg:inline-block group cursor-pointer w-fit"
                        ...
                        <div className="flex justify-center lg:justify-start col-span-2 order-1 lg:order-2">
                            <div className="mx-auto mt-4 w-65 sm:w-[320px] md:w-95 lg:mt-0 lg:mx-0 lg:w-107.5 xl:w-117.5 2xl:w-127.5">
                                <div
                                    className="h-100 w-65 overflow-hidden rounded-t-[160px] rounded-b-none p-px sm:h-120 sm:w-80 sm:rounded-t-[200px] md:h-130 md:w-90 md:rounded-t-[230px] lg:h-145 lg:w-100 lg:rounded-t-[250px] xl:h-150 xl:w-115 xl:rounded-t-[270px] 2xl:h-130 2xl:w-117.5 2xl:rounded-t-[290px]"
                                    style={{ background: "var(--dark-gold)" }}
                                >
                                    <div className="relative h-full w-full overflow-hidden rounded-t-[inherit] rounded-b-none bg-white p-1">
                                        <div
