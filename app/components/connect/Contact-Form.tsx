                        ...
                        <div>
                            ...
                            <div className="pt-4 flex justify-center lg:justify-end">
                                <div className="relative inline-block group cursor-pointer">
                                    ...
                                    <button
                                        type="submit"
                                        className="relative py-3 px-16 rounded-r-full text-white font-medium text-sm lg:text-base xl:text-lg transition-all duration-300 group-hover:-translate-x-3.5 group-hover:translate-y-4.5"
                                        style={{
