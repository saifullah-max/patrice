export default function AboutBanner() {
    return (
        <section className="max-w-7xl mx-auto px-6 pt-12 md:px-10 lg:px-12 xl:px-14 py-4 lg:py-8 xl:py-10">
            <div className="max-w-5xl  mx-auto">
                <div className="bg-(--dark-orange) py-4 lg:py-6 px-6 lg:px-8 xl:px-10 rounded-xl">
                    <p className="flex flex-col text-center text-white text-xl lg:text-2xl xl:text-[32px] font-normal">
                        <span className="font-satisfy">“When your inner system recalibrates, life reorganizes.”</span>
